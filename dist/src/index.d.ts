...
export { readEvents, logEvent, recordScore, clearEvents, } from "./telemetry";
...
export { installCommand, uninstallCommand, isCommandInstalled, commandPath, menuCommandPath, updateCommandPath, } from "./command";
export { loadManifest, normalizeManifest } from "./manifest";
export { isNewer, readUpdateCache, cacheIsStale, fetchLatestVersion, refreshUpdateCache, updateStatus, runUpdate, } from "./update";
